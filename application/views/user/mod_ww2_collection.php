...
<div class="fond-color3">
    <div class="container" style="min-height: 535px;">
        ...
        <? $collectionName = "ww2" ?> <!-- 2NDE GUERRE MONDIALE -->
        <div class="row py-5">
            <div class="mt-5">
            ...
            <div class="col-md-9 col-sm-9 col-12 ml-3">
                <?$haveTable = str_split($collection->ww2_have);
                ...
                if($haveTable[0] > 0){?>
                    ...
                    <div class="d-flex">
                        <div>
                            ...
                            <? $doubleTable = str_split($collection->ww2_double);
                            $double_aff = "";
                            for($i=1 ; $i < 61 ; $i++){
                                if($doubleTable[$i] !== "0"){
                            ...
                            <input type="hidden" value="<?=$collection->ww2_double?>" name="double">
                            <? echo validation_errors(); ?>
                        </div>
                    </div>
